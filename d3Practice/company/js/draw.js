...
function drawFunction(){
    ...
    var margin = {top: 50, right: view_height>view_width ? 30 : 0, bottom: 30, left: 60},
        width = document.getElementById("scatter"+isP).clientWidth - margin.left - margin.right,
        height = document.getElementById("scatter"+isP).clientHeight - margin.top - margin.bottom;
    ...
    var svg = d3.select("#scatter"+isP).append("svg")
        .attr("id","plot")
    ...
    d3.csv("data.csv", function(error, data) {
      ...
      svg.append("g")
        ...
        .append("text")
          ...
          .attr("y", 0)
          .attr("dx", "-.3em")
          .attr("dy", function(d){return view_height>view_width ? "0em" : "1.35em"})
    ...
    //      .attr("transform", "rotate(-90)")
      ...
      svg.selectAll(".dot")
        ...
        function clickFunction(clickedItem, idx){
            ...
            var follower = document.getElementById("followers"+isP),
                employee = document.getElementById("employees"+isP),
                commitment = document.getElementById("commitment"+isP),
                publication = document.getElementById("publications"+isP)
            ...
            var logo = document.getElementById("logo"+isP)
